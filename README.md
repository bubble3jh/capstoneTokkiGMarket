...
[`500픽셀|가운데`](파일:2-2-1.png "wikilink")\
...
#### 개발 일정
  ...
  ---------------------------------------------------------------------------------------- --------------- ------ -------------------- --- --- -- --
  단계별 세부개발 내용                                                                     담당자          단가   rowspan= "2" |비고
  3                                                                                        4               5      6
  프로토타입 만들기                                                                        김민혜          √      
  \[블록체인\] Smart Contract 작성하기                                                     김민혜          √      √
  \[블록체인\] 블록체인 개발 환경 구성하기                                                 김민혜,박지원   √      
  \[블록체인\] Smart Contract 예제 Test net에 배포하기                                     박지원          √      
  \[블록체인\] Smart Contract 예제 Main net에 배포하기                                     박지원                 √
  \[블록체인\] 작성한 Smart Contract 테스트넷, 메인넷에 배포하기                           박지원                 
  \[블록체인\] 배포한 Smart Contract 웹에서 불러오기                                       김민혜                 
  \[데이터베이스\] DB에 저장할 목록 별 테이블 구성하기                                     강진호          √      √
  \[프론트앤드\] 메인홈페이지, 로그인 후 메인페이지, 판매페이지, 판매정보페이지 구성하기   장호진          √      √
  \[프론트앤드\] 회원가입 절차 페이지, 마이페이지 구성하기                                 이희진          √      √
  \[프론트앤드\] 판매 물품 업로드 페이지, 거래후기페이지 구성하기                          장호진                 
  \[데이터베이스, 서버\] 웹과 DB 연결하기                                                  강진호                 
  \[데이터베이스, 서버\] 회원가입 기능, 로그인 기능 구현하기                               이희진                 
  \[데이터베이스, 서버\] 구매 기능, 판매 기능, 채팅 기능 구현하기                          장호진                 √
  \[데이터베이스, 서버\] 신원 정보 확인 기능, 거래 후기 작성 기능 구현하기                 이희진                 √
  \[블록체인, 데이터베이스, 프론트앤드, 서버\] 추가 기능(사진 도용 방지 기능 등)           팀원 모두              
  \[블록체인, 데이터베이스, 프론트앤드, 서버\] 완성품 평가 및 보완하기                     팀원 모두              
  ---------------------------------------------------------------------------------------- --------------- ------ -------------------- --- --- -- --
...
[500픽셀|가운데](파일:02-02.png "wikilink")
...
[파일:noname19.jpg](파일:noname19.jpg "wikilink")

-   구매 내역 – 구매 완료

[파일:noname20.jpg](파일:noname20.jpg "wikilink")

-   판매 내역 – 판매 중

[파일:noname21.jpg](파일:noname21.jpg "wikilink")

-   판매 내역 – 판매 완료

[파일:noname22.jpg](파일:noname22.jpg "wikilink")

-   거래 후기

[파일:noname23.jpg](파일:noname23.jpg "wikilink")

-   채팅방 보여주기

[파일:noname24.jpg](파일:noname24.jpg "wikilink")

-   판매 작성 페이지

[파일:noname25.jpg](파일:noname25.jpg "wikilink")

-   거래 후기 작성 페이지

[파일:noname26.jpg](파일:noname26.jpg "wikilink")

-   프로필 수정 페이지

[파일:noname27.jpg](파일:noname27.jpg "wikilink")

-   신고하기 페이지

[파일:noname28.jpg](파일:noname28.jpg "wikilink")

### 데이터베이스 설계

-   DBMS

[파일:noname29.jpg](파일:noname29.jpg "wikilink")
...
[파일:noname30.jpg](파일:noname30.jpg "wikilink")

[파일:noname31.jpg](파일:noname31.jpg "wikilink")

1.  history

[파일:noname32.jpg](파일:noname32.jpg "wikilink")

1.  post

[파일:noname33.jpg](파일:noname33.jpg "wikilink")

1.  file

[파일:noname34.jpg](파일:noname34.jpg "wikilink")

1.  comments

[파일:noname35.jpg](파일:noname35.jpg "wikilink")

1.  chats

[파일:noname36.jpg](파일:noname36.jpg "wikilink")

1.  counters

[파일:noname37.jpg](파일:noname37.jpg "wikilink")

1.  review

[파일:noname38.jpg](파일:noname38.jpg "wikilink")
...
[파일:작동화면1.png](파일:작동화면1.png "wikilink")

` 3) 블록체인 서버와 연결 후 배포`\
` 이 때, 사용한 이더계정과 배포한 스마트 컨트랙트의 주소를 추후 웹 서버에서 스마트 컨트랙트 호출할 때 사용`

[파일:작동화면2.png](파일:작동화면2.png "wikilink")
...
[파일:작동화면3.png](파일:작동화면3.png "wikilink")

`  2) 사기 접수된 사용자의 아이디 입력 `

[파일:작동사진4.png](파일:작동사진4.png "wikilink")

`  3) 사기 접수된 사용자의 신원 정보 조회 `

[파일:작동화면5.png](파일:작동화면5.png "wikilink")

` + 이더리움 리믹스를 통해 점검 `\
` 스마트 컨트랙트에서는 인덱스 번호를 통해 회원을 구분함. 따라서 웹에서 호출 시 해당 아이디의 인덱스 번호로 호출 `

[파일:작동사진6.png](파일:작동사진6.png "wikilink")
...
[파일:작동사진7.png](파일:작동사진7.png "wikilink")

`  + 이더리움 리믹스를 통해 점검한다.  `\
`  유효하지 않은 주민번호인 경우 0을 리턴한다.`

[파일:작동사진8.png](파일:작동사진8.png "wikilink")

`  - 이미 해당 주민번호로 가입을 했을 경우 `

[파일:작동화면9.png](파일:작동화면9.png "wikilink")

`  + 이더리움 리믹스를 통해 점검`\
`  이미 가입된 계정인 경우 3을 리턴한다.`

[파일:작동화면10.png](파일:작동화면10.png "wikilink")

`  - 유효하며, 이미 가입된 번호가 아닌 경우`

[파일:작동화면11.png](파일:작동화면11.png "wikilink")

`  + 이더리움 리믹스로 확인`\
`  유효한 주민번호일 경우 1을 리턴, 가입되지 않은 주민번호일 경우 2를 리턴한다.`

[파일:작동화면12.png](파일:작동화면12.png "wikilink")
[파일:작동화면13.png](파일:작동화면13.png "wikilink")

`  - 주민번호를 등록된 주민번호로 블록에 저장`

[파일:작동화면14.png](파일:작동화면14.png "wikilink")'

`  - 회원정보 블록에 저장`

[파일:작동화면15.png](파일:작동화면15.png "wikilink")
...
[파일:작동화면26.png](파일:작동화면26.png "wikilink")

[파일:작동화면27.png](파일:작동화면27.png "wikilink")
...
[파일:작동화면28.png](파일:작동화면28.png "wikilink")

`  2) 검색된 게시물을 확인한다.`

[파일:작동화면29.png](파일:작동화면29.png "wikilink")

`• 게시물 목록 확인`\
` 1) 또는 전체 판매 게시판에서 판매 중인 물품에 대한 게시물 목록을 확인할 수 있다.`

[파일:작동화면30.png](파일:작동화면30.png "wikilink")

`• 판매자의 거래후기 목록 확인`\
`1) 거래를 진행하기 전 게시물 작성자 닉네임을 클릭하여 상대방에게 작성된 거래후기 목록을 확인할 수 있다.`

[파일:작동화면31.png](파일:작동화면31.png "wikilink")
...
[파일:작동화면32.png](파일:작동화면32.png "wikilink")

`• 판매자와 채팅하기`\
` 1) 채팅 화면에서 상대방과의 채팅을 진행한다.`

[파일:작동화면33.png](파일:작동화면33.png "wikilink")

`• 마이페이지의 채팅목록`\
` 1) 마이페이지의 채팅목록에 상대방의 닉네임이 생성된 것을 확인할 수 있으며 닉네임을 클릭하여 진행 중인 채팅을 이어나갈 수 있다.`

[파일:작동화면34.png](파일:작동화면34.png "wikilink")
[파일:작동화면35.png](파일:작동화면35.png "wikilink")

`• 거래후기 작성하기`\
` 1) 마이페이지의 거래후기 작성 버튼을 클릭하여 채팅 진행 중인 사용자에 대해 후기를 작성할 수 있다.`

[파일:작동화면36.png](파일:작동화면36.png "wikilink")

[파일:작동화면37.png](파일:작동화면37.png "wikilink")

[파일:작동화면38.png](파일:작동화면38.png "wikilink")

`• 신고하기`\
` 1) 사기 상황이 발생한 경우, 마이페이지의 신고하기 버튼을 클릭하여 매뉴얼에 따라 신고 절차를 진행한다.`

[파일:작동화면39.png](파일:작동화면39.png "wikilink")
...
[파일:작동화면40.png](파일:작동화면40.png "wikilink")

` 2)　제목, 상품사진, 가격, 상품 상세 내용을 작성 후 작성내용 버튼 클릭`

[파일:작동화면41.png](파일:작동화면41.png "wikilink")
...
4\. 반응 시간 1）측정 결과
  ...
  ---------------------- ----------------------------------------------------- -----------------------------------------------------
  데스트탑               속도점수                                              [파일:평가사진1.png](파일:평가사진1.png "wikilink")
  가능한 최적화 리스트   [파일:평가사진2.png](파일:평가사진2.png "wikilink")
  모바일                 속도점수                                              [파일:평가사진3.png](파일:평가사진3.png "wikilink")
  가능한 최적화 리스트   [파일:평가사진4.png](파일:평가사진4.png "wikilink")
  ---------------------- ----------------------------------------------------- -----------------------------------------------------
